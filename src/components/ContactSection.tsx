...
import { PropertyMapShowcase } from "./PropertyMapShowcase";
import { SectionEyebrow } from "./ui/SectionEyebrow";

export function ContactSection() {
  return (
    <section id="contact" className="relative bg-[#fcfcfc]">
          ...
          <div className="grid gap-12 lg:grid-cols-[minmax(0,1fr)_minmax(0,420px)] lg:items-start lg:gap-16">
            <div className="max-w-xl">
              ...
              <p className="mt-4 text-base leading-relaxed text-neutral-600">
                Planning a mountain escape? Visit us at{" "}
                <span className="font-medium text-black">
                  {poconosLocation.street}
                </span>{" "}
                in {poconosLocation.city} or ask about listings across the{" "}
                {poconosLocation.region}.
              </p>
            </div>
