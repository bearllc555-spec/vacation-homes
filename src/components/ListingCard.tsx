...
export function ListingCard({ listing }: ListingCardProps) {
  return (
    <article className="w-[376px] max-w-[calc(100vw-3rem)] shrink-0 snap-start">
      <div className="relative aspect-[376/476] overflow-hidden rounded-2xl bg-neutral-100">
        <img
          src={listing.image}
          alt={listing.name}
        ...
        <div className="absolute bottom-4 left-4 right-4 flex h-[88px] flex-col justify-center rounded-lg bg-[#fcfcfc] px-4">
          ...
          <h3 className="mt-0.5 truncate text-sm font-medium tracking-tight text-black">
            {listing.name}
          </h3>
